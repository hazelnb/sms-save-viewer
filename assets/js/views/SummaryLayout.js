...
const SummaryLayout = {
    view: (vnode) => {
      vnode.paren
      return [m(SMSTextBox, {className: "titleBox"}, m("p.contents", 'Sunshine Scorecard')), m("#summaryLayout", [m(SlotSelect), m("#tables", [m(ShineTable), m(BluesTable)]), m(BluesSortInput, {name: "Vanilla", class_name: "VanillaArea", sorts: [["mario_party_legacy_num", "Mario Party Legacy order"], ["mario_wiki_num", "Mario Wiki order"], ["mem_num", "Memory order"]]}),
